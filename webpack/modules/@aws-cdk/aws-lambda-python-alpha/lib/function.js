...
const original = require("../../../../../node_modules/@aws-cdk/aws-lambda-python-alpha/lib/function");

class WebPythonFunction extends original.PythonFunction {
...
module.exports = { ...original, PythonFunction: WebPythonFunction };
